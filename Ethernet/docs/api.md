# Ethernet Library
  ...
  - [Ethernet Class](#ethernet-class)
    - [`Ethernet.begin()`](#ethernetbegin)
    - [`Ethernet.dnsServerIP()`](#ethernetdnsserverip)
    - [`Ethernet.gatewayIP()`](#ethernetgatewayip)
    - [`Ethernet.hardwareStatus()`](#ethernethardwarestatus)
    - [`Ethernet.init()`](#ethernetinit)
    - [`Ethernet.linkStatus()`](#ethernetlinkstatus)
    - [`Ethernet.localIP()`](#ethernetlocalip)
    - [`Ethernet.MACAddress()`](#ethernetmacaddress)
    - [`Ethernet.maintain()`](#ethernetmaintain)
    - [`Ethernet.setDnsServerIP()`](#ethernetsetdnsserverip)
    - [`Ethernet.setHostName()`](#ethernetsethostname)
    - [`Ethernet.getHostName()`](#ethernetgethostname)
    - [`Ethernet.hostByName()`](#ethernethostbyname)
    - [`Ethernet.setGatewayIP()`](#ethernetsetgatewayip)
    - [`Ethernet.setLocalIP()`](#ethernetsetlocalip)
    - [`Ethernet.setMACAddress()`](#ethernetsetmacaddress)
    - [`Ethernet.setRetransmissionCount()`](#ethernetsetretransmissioncount)
    - [`Ethernet.setRetransmissionTimeout()`](#ethernetsetretransmissiontimeout)
    - [`Ethernet.setSubnetMask()`](#ethernetsetsubnetmask)
    - [`Ethernet.subnetMask()`](#ethernetsubnetmask)
  - [IPAddress Class](#ipaddress-class)
    - [`IPAddress()`](#ipaddress)
  - [Server Class](#server-class)
    - [`Server`](#server)
    - [`EthernetServer()`](#ethernetserver)
    - [`server.begin()`](#serverbegin)
    - [`server.accept()`](#serveraccept)
    - [`server.available()`](#serveravailable)
    - [`if(server)`](#ifserver)
    - [`server.write()`](#serverwrite)
    - [`server.print()`](#serverprint)
    - [`server.println()`](#serverprintln)
  - [Client Class](#client-class)
    - [`Client`](#client)
    - [`EthernetClient()`](#ethernetclient)
    - [`if (EthernetClient)`](#if-ethernetclient)
    - [`client.connected()`](#clientconnected)
    - [`client.connect()`](#clientconnect)
    - [`client.localPort()`](#clientlocalport)
    - [`client.remoteIP()`](#clientremoteip)
    - [`client.remotePort()`](#clientremoteport)
    - [`client.setConnectionTimeout()`](#clientsetconnectiontimeout)
    - [`client.write()`](#clientwrite)
    - [`print()`](#print)
    - [`client.println()`](#clientprintln)
    - [`client.available()`](#clientavailable)
    - [`client.read()`](#clientread)
    - [`client.flush()`](#clientflush)
    - [`client.stop()`](#clientstop)
  - [EthernetUDP Class](#ethernetudp-class)
    - [`EthernetUDP.begin()`](#ethernetudpbegin)
    - [`EthernetUDP.read()`](#ethernetudpread)
    - [`EthernetUDP.write()`](#ethernetudpwrite)
    - [`EthernetUDP.beginPacket()`](#ethernetudpbeginpacket)
    - [`EthernetUDP.endPacket()`](#ethernetudpendpacket)
    - [`EthernetUDP.parsePacket()`](#ethernetudpparsepacket)
    - [`EthernetUDP.available()`](#ethernetudpavailable)
  - [UDP class](#udp-class)
    - [`UDP.stop()`](#udpstop)
    - [`UDP.remoteIP()`](#udpremoteip)
    - [`UDP.remotePort()`](#udpremoteport)
...
Initializes the Ethernet library and network settings. All versions of this function require you to pass the `SPI` bus instance as the first parameter.

With version 1.0, the library supports DHCP. Using `Ethernet.begin(SPI, mac)` with the proper network setup, the Ethernet shield will automatically obtain an IP address. This increases the sketch size significantly. To make sure the DHCP lease is properly renewed when needed, be sure to call `Ethernet.maintain()` regularly.

#### Syntax

```cpp
Ethernet.begin(spi, mac);
Ethernet.begin(spi, mac, ip);
Ethernet.begin(spi, mac, ip, dns);
Ethernet.begin(spi, mac, ip, dns, gateway);
Ethernet.begin(spi, mac, ip, dns, gateway, subnet);
```

#### Parameters
- **spi**: the SPI bus instance (e.g., SPI).
...
#### Returns
- The DHCP version of this function, Ethernet.begin(spi, mac), returns an int: 1 on a successful DHCP connection, 0 on failure. 
...
void setup() {
  Ethernet.begin(SPI, mac, ip, myDns);
...
Get the IP address assigned to the hostname.

#### Syntax

```cpp
Ethernet.hostByName(hostname, result)
```

#### Parameters
- **hostName**: network device hostname (const char*)
- **result**: reference to the variable in which the IP address assigned to the **hostname** will be stored

#### Returns
- **int**: 1 if **hostName** was successfully converted to an IP address, else error code
- **result**: the IP address of network device
...
void setup() {
  Ethernet.begin(SPI, mac, ip, myDns, gateway);
...
void setup() {
  Ethernet.begin(SPI, mac, ip, myDns, gateway, subnet);
...
void setup() {
  ...
  Ethernet.begin(SPI, mac, ip, dnServer, gateway, subnet);
...
{
  // initialize the ethernet device
  Ethernet.begin(SPI, mac, ip, gateway, subnet);
